...
class TestState(unittest.TestCase):
    ...
    def test_get_status(self):
        res = app.test_client().get('/api/v1/states')
    ...
    def test_delete_state(self):
        res = app.test_client().delete('/api/v1/states/random_id')
    ...
    def test_post_state(self):
        ...
        res = app.test_client().post('/api/v1/states',
    ...
    def test_put_city(self):
        ...
        res = app.test_client().put('/api/v1/states/{}'.format(a_state.get('id')),
